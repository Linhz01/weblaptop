...
ModalContentComponent.ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "13.3.3", ngImport: i0, type: ModalContentComponent, deps: [{ token: i0.ElementRef }, { token: i1.InteractivityChecker }], target: i0.ɵɵFactoryTarget.Component });
